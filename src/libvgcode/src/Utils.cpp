...
// [INTENT] Appends position and normal to vertex buffer
...
// [INTENT] Appends indices to triangle buffer
...
// [INTENT] Dot product of two vectors
float dot(const Vec3& v1, const Vec3& v2) { return v1[0] * v2[0] + v1[1] * v2[1] + v1[2] * v2[2]; }

// [INTENT] Length of vector
float length(const Vec3& v) { return std::sqrt(dot(v, v)); }

bool operator==(const Vec3& v1, const Vec3& v2) { return v1[0] == v2[0] && v1[1] == v2[1] && v1[2] == v2[2]; }
...
Vec3 operator*(float f, const Vec3& v) { return {f * v[0], f * v[1], f * v[2]}; }
