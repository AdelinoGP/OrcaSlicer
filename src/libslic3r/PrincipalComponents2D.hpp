...
// [INTENT] Compute unnormalized area moments for one triangle to build covariance terms for polygon principal-axis analysis.
...
// [COUPLING] Used by orientation / packing logic that assumes deterministic eigenvector ordering across platforms.
// [HAZARD] Nearly symmetric inputs can produce numerically unstable axis flips; downstream code must tolerate 180-degree ambiguity.
