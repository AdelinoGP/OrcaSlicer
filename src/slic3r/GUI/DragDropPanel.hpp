// [ANNOTATED]
// [INTENT] Declarations for the interactive filament reordering panel and its individual color chips.
// [STATE] Managed collection of ColorPanel instances; tracks drag status and chip metadata (color, type).
// [UNITY] Map DragDropPanel to a C# UI controller. Replace ColorPanel with a chip prefab + MonoBehaviour.
// [PORTING_HAZARD:P3] Heavy reliance on wxWidgets panel-based hierarchy for draggable items.
