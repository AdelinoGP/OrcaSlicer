// [ANNOTATED]
// [INTENT] Declaration of the high-level download management service and task models.
// [STATE] Tracks active download sessions, user actions, and state transitions (Pending, Ongoing, Paused, etc.).
// [UNITY] Map to a C# DownloadService using an ObservableCollection<DownloadTask> for UI data-binding.
// [PORTING_HAZARD:P3] Heavy reliance on wxWidgets event handling; replace with standard C# event patterns or UniTask.
