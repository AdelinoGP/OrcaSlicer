...
MonitorBasePanel::MonitorBasePanel(wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name)
    : wxPanel(parent, id, pos, size, style, name)
{
    ...
    m_staticText_machine_name = new wxStaticText(m_panel_printer, wxID_ANY, wxT("BBL-Printer001"), wxDefaultPosition, wxSize(-1, -1),
                                                 wxST_ELLIPSIZE_END | wxST_ELLIPSIZE_MIDDLE | wxST_ELLIPSIZE_START);
    m_staticText_machine_name->Wrap(-1);
    m_staticText_machine_name->SetFont(
    ...
    m_staticText_status = new wxStaticText(m_panel_status_tab, wxID_ANY, wxT("Status"), wxDefaultPosition, wxSize(-1, -1),
                                           wxST_ELLIPSIZE_END);
    m_staticText_status->Wrap(-1);
    m_staticText_status->SetFont(
        wxFont(14, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("@HarmonyOS Sans SC")));
    ...
    m_staticText_time_lapse = new wxStaticText(m_panel_time_lapse_tab, wxID_ANY, wxT("Time Lapse"), wxDefaultPosition, wxSize(-1, -1),
                                               wxALIGN_LEFT | wxST_ELLIPSIZE_END);
    m_staticText_time_lapse->Wrap(-1);
    m_staticText_time_lapse->SetFont(
        wxFont(14, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("@HarmonyOS Sans SC")));
    ...
    m_staticText_video_monitoring = new wxStaticText(m_panel_video_tab, wxID_ANY, wxT("Video"), wxDefaultPosition, wxSize(-1, -1),
                                                     wxALIGN_LEFT | wxST_ELLIPSIZE_END);
    m_staticText_video_monitoring->Wrap(-1);
    m_staticText_video_monitoring->SetFont(
        wxFont(14, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("@HarmonyOS Sans SC")));
    ...
    m_staticText_subtask_list = new wxStaticText(m_panel_task_list_tab, wxID_ANY, wxT("Task List"), wxDefaultPosition, wxSize(-1, -1),
                                                 wxALIGN_LEFT | wxST_ELLIPSIZE_END);
    m_staticText_subtask_list->Wrap(-1);
    m_staticText_subtask_list->SetFont(
        wxFont(14, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("@HarmonyOS Sans SC")));
    ...
    m_splitter->Connect(wxEVT_COMMAND_SPLITTER_SASH_POS_CHANGING,
                        wxSplitterEventHandler(MonitorBasePanel::m_splitterOnSplitterSashPosChanging), NULL, this);
}

MonitorBasePanel::~MonitorBasePanel()
{
    m_splitter->Disconnect(wxEVT_COMMAND_SPLITTER_SASH_POS_CHANGING,
                           wxSplitterEventHandler(MonitorBasePanel::m_splitterOnSplitterSashPosChanging), NULL, this);
}
...
// [UNITY] MonitorBasePanel: Root layout, TwoPaneLayout (Splitter).
// [UNITY] VideoMonitoringBasePanel: RawImage + VideoPlayer.
// [UNITY] TaskListBasePanel: ScrollView + List of TaskItemVisualElements.
// [PORTING_HAZARD:P3] Heavy usage of absolute sizing.
// [UNCLEAR] Some event handlers rely on wxSplitterWindow state, verify binding.

///////////////////////////////////////////////////////////////////////////
// C++ code generated with wxFormBuilder (version 3.10.1-0-g8feb16b3)
// http://www.wxformbuilder.org/
//
// PLEASE DO *NOT* EDIT THIS FILE! (Annotations added for porting purposes)
///////////////////////////////////////////////////////////////////////////
    ...
    : wxPanel(parent, id, pos, size, style, name)
{
    ...
    m_staticText_model_name->SetFont(
        wxFont(14, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxT("HarmonyOS Sans SC")));
    ...
    m_staticText_task_desc = new wxStaticText(m_panel_model_name_content, wxID_ANY,
                                              wxT("Robort expose task dao movie with smart part \ndesigned for new year\n"),
    ...
    m_staticText_ceation_time_title = new wxStaticText(m_panel_model_name_content, wxID_ANY, wxT("CreationTime:"), wxDefaultPosition,
                                                       wxDefaultSize, 0);
