...
// [ANNOTATED]
// [INTENT] Declarations for Daily Tips UI components (Panel and Modal Window).
// [STATE] Manages UI lifecycle (open/close), expansion state, and rendering parameters (pos, size, opacity).
// [UNITY] Map DailyTipsPanel to a MonoBehaviour managing a retained UI Toolkit or Canvas-based Panel prefab.
// [UNITY] Map DailyTipsWindow to a Modal Dialog controller in C#.
// [PORTING_HAZARD:P3] Heavy reliance on ImGui-specific types (ImVec2) and immediate-mode lifecycle.

namespace Slic3r { namespace GUI {

enum class DailyTipsLayout { Horizontal, Vertical };
