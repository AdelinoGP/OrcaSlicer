...
// [INTENT] ModelMallDialog provides a web-based interface for browsing and publishing 3D models.
// [UNITY] Use a Unity WebView component (e.g., UniWebView) to render the web interface.
// [STATE] Manages a wxWebView instance (m_browser) and a control panel for navigation.
// [EVENT] Handles browser navigation (back, forward, refresh) and script-to-native communication via OnScriptMessage.
               ...
               wxCLOSE_BOX | wxDEFAULT_DIALOG_STYLE | wxMAXIMIZE_BOX | wxMINIMIZE_BOX | wxRESIZE_BORDER)
{
    ...
    auto m_control_back = new ScalableButton(m_web_control_panel, wxID_ANY, "mall_control_back", wxEmptyString, wxDefaultSize,
    ...
    auto m_control_forward = new ScalableButton(m_web_control_panel, wxID_ANY, "mall_control_forward", wxEmptyString, wxDefaultSize,
                                                wxDefaultPosition, wxBU_EXACTFIT | wxNO_BORDER, true);
    ...
    auto m_control_refresh = new ScalableButton(m_web_control_panel, wxID_ANY, "mall_control_refresh", wxEmptyString, wxDefaultSize,
                                                wxDefaultPosition, wxBU_EXACTFIT | wxNO_BORDER, true);
...
// [EVENT] Native bridge for script messages from the web UI to the application.
// [UNITY] Use a JS-to-C# bridge to handle communication.
