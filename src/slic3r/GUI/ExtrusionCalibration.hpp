// [ANNOTATED]
// [INTENT] Declaration of the manual Pressure Advance (Factor K) calibration wizard and setup models.
// [STATE] Tracks active printer reference, material parameters, and resulting calibration factors.
// [UNITY] Map to a C# ModalDialog or Wizard controller managing a step-based VisualElement UI.
// [PORTING_HAZARD:P3] Heavy reliance on wxWidgets-specific UI types and manual DPI scaling logic.
