// [ANNOTATED]
// [INTENT] Custom G-code editor dialog with real-time placeholder search and insertion.
// [STATE] Hierarchical model (ParamsModel) tracks hundreds of built-in and preset-derived placeholders for G-code scripting.
// [EVENT] Reactive search filtering and placeholder activation (double-click to insert) logic.
// [UNITY] Map to a Unity UI Toolkit ModalWindow. Replace wxDataViewCtrl with a TreeView bound to a C# placeholder model.
// [PORTING_HAZARD:P2] Complex logic for dynamic placeholder discovery from active presets and slicing state must be mirrored in the C#
// service layer.
                ...
                wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER)
{
    ...
    m_gcode_editor = new wxTextCtrl(this, wxID_ANY, wxString::FromUTF8(value), wxDefaultPosition, wxDefaultSize,
                                    wxTE_MULTILINE
#ifdef _WIN32
                                        | wxBORDER_SIMPLE
#endif
