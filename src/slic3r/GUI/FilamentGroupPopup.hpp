// [ANNOTATED]
// [INTENT] Declaration of the mode selector popup for automated filament grouping strategies.
// [STATE] Tracks current selection mode, printer connectivity, and manages UI element lists for radio-style buttons.
// [UNITY] Map to a C# floating UI controller managing a retained VisualElement tree.
// [UNITY] Replace wxTimer with a C# Timer or async Task.Delay for automatic dismissal.
// [PORTING_HAZARD:P3] Reliance on specialized PopupWindow and manual bitmap state management.
