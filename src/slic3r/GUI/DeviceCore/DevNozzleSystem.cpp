// [ANNOTATED]
// [INTENT] Management and telemetry parsing for the printer's nozzle system.
// [STATE] Tracks nozzle metadata (diameter, material type, flow capability) and toolhead presence.
// [UNITY] Map to a C# NozzleService managing toolhead nozzle configurations.
// [PORTING_HAZARD:P2] String-to-enum parsing for nozzle types and bit-packed toolhead existence flags must be mirrored exactly.
...
static unordered_map<string, NozzleFlowType> _str2_nozzle_flow_type = {{"S", NozzleFlowType::S_FLOW},
                                                                       {"H", NozzleFlowType::H_FLOW},
                                                                       {"A", NozzleFlowType::S_FLOW},
                                                                       {"X", NozzleFlowType::S_FLOW}};

static unordered_map<string, NozzleType> _str2_nozzle_type = {{"00", NozzleType::ntStainlessSteel},
