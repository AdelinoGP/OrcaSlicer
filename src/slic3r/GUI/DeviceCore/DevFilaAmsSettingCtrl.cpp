// [ANNOTATED]
// [INTENT] Control logic for initiating AMS unit firmware switches/upgrades.
// [EVENT] Dispatches the "mc_for_ams_firmware_upgrade" JSON command and initializes a tracked DevCtrlInfo session.
// [UNITY] Map to a C# async method in the AMSService or FirmwareService.
