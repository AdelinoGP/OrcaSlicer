...
// [ANNOTATED]
// [INTENT] Declaration of the dynamic printer error/HMS dialog and recovery action enums.
// [STATE] Stores printer reference, error codes, and dynamic button lists.
// [UNITY] Map ActionButton enum to C# for command dispatching.
// [UNITY] Replace wxWidgets UI members with VisualElement references or SerializedFields in a MonoBehaviour.
// [PORTING_HAZARD:P3] Async image loading via wxWebRequest must map to UnityWebRequest in C#.
