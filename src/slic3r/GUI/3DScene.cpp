...
// PNP fork (F12): SLA removed — no SLA support/pad volumes exist in this fork.
bool GLVolume::is_sla_support() const { return false; }
bool GLVolume::is_sla_pad() const { return false; }
