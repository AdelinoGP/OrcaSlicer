...
public:
    ...
    ConfigOptionsGroupShp       new_optgroup(const wxString& title,
...
public:
    ...
    void add_scaled_button(wxWindow*          parent,
                           ScalableButton**   btn,
    ...
    void save_preset(std::string name            = std::string(),
                     bool        detach          = false,
...
public:
    // BBS: GUI refactor
    TabPrint(ParamsPanel* parent, Preset::Type type = Preset::TYPE_PRINT) : Tab(parent, _(L("Process")), type) {}
    ~TabPrint() {}
...
public:
    // BBS: GUI refactor
    TabFilament(ParamsPanel* parent) : Tab(parent, _(L("Filament")), Slic3r::Preset::TYPE_FILAMENT) {}
    ~TabFilament() {}
...
public:
    ...
    // BBS: GUI refactor
    TabPrinter(ParamsPanel* parent) : Tab(parent, _L("Machine"), Slic3r::Preset::TYPE_PRINTER) {}
    ~TabPrinter() {}
...
public:
    // BBS: GUI refactor
    TabSLAMaterial(ParamsPanel* parent) : Tab(parent, _(_devL("Material Settings")), Slic3r::Preset::TYPE_SLA_MATERIAL) {}
    ~TabSLAMaterial() {}
...
public:
    // BBS: GUI refactor
    TabSLAPrint(ParamsPanel* parent) : Tab(parent, _(L("Process Settings")), Slic3r::Preset::TYPE_SLA_PRINT) {}
    ~TabSLAPrint() {}
