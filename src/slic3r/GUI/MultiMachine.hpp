...
/*
 [INTENT] Defines the UI component for a single printer/machine item in the Multi-Machine management list.
 [UNITY] Replace with a Unity UI Toolkit VisualElement or a MonoBehaviour-based list item prefab.
*/
...
public:
    ...
    int            state_local_task{0}; // 0-padding  1-sending 2-sending finish  3-sending cancel  4-sending failed 5-TS_PRINT_SUCCESS 6-
                                        // TS_PRINT_FAILED 7-TS_REMOVED 8-TS_IDLE
...
/*
 [EVENT] Event declarations for Multi-Machine manager GUI interactions.
 [UNITY] Reimplement as C# Events or `UnityEngine.Events.UnityEvent` for decoupling UI and business logic.
*/
