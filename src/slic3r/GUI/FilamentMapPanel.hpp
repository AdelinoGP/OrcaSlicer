...
// [ANNOTATED]
// [INTENT] Declarations for sub-panels used in the multi-mode filament mapping UI.
// [STATE] Managed UI state for manual toolhead assignment and automated strategy selection.
// [UNITY] Map each panel class to a C# Controller managing a retained VisualElement tree.
// [UNITY] Replace owner-drawn button panels with styled Unity UI Button prefabs.
