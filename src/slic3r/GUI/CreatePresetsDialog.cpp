...
// [ANNOTATED]
// [INTENT] This file implements a suite of dialogs for managing (creating, editing, and exporting) printer and filament presets.
// [STATE] These dialogs maintain transient local copies of Preset objects and mapping between UI widgets (checkboxes, comboboxes) and
// Preset metadata. [EVENT] Heavily uses wxEVT_COMBOBOX for cascading selection logic and wxEVT_BUTTON for committing changes back to the
// global PresetBundle. [UNITY] Most of these dialogs should map to Unity UI Toolkit Modal Windows or multi-step Wizard components using
// ScriptableObject-backed data models. [PORTING_HAZARD:P2] The preset cloning logic (clone_presets_for_filament/printer) directly mutates
// DynamicPrintConfig objects and interacts with the global PresetBundle; this needs a clean Service layer in Unity. [PORTING_HAZARD:P2]
// Extensive use of static vendor/model maps (filament_vendors, printer_model_map) which should be externalized to JSON/ScriptableObjects in
// Unity.
...
// [STATE] Static metadata for filament vendors and types.
// [UNITY] Map these to a JSON or ScriptableObject-backed database for easier maintenance.
static const std::vector<std::string> filament_vendors = {"3Dgenius",
                                                          "3DJake",
                                                          "3DXTECH",
                                                          "3D BEST-Q",
                                                          "3D Hero",
...
static const std::vector<std::string> filament_types = {"PLA",  "rPLA",   "PLA+",   "PLA Tough",    "PETG",  "ABS",    "ASA",
                                                        "FLEX", "HIPS",   "PA",     "PACF",         "NYLON", "PVA",    "PVB",
                                                        "PC",   "PCABS",  "PCTG",   "PCCF",         "PHA",   "PP",     "PEI",
                                                        "PET",  "PETGCF", "PTBA",   "PTBA90A",      "PEEK",  "TPU93A", "TPU75D",
                                                        "TPU",  "TPU92A", "TPU98A", "Misc",         "TPE",   "GLAZE",  "Nylon",
                                                        "CPE",  "METAL",  "ABST",   "Carbon Fiber", "SBS"};

static const std::vector<std::string> printer_vendors = {"Anker",          "Anycubic",
                                                         "Artillery",      "Bambulab",
                                                         "BIQU",           "Blocks",
                                                         "Chuanying",      "Co Print",
                                                         "Comgrow",        "CONSTRUCT3D",
                                                         ...
                                                         "Dremel",         "Elegoo",
                                                         "Flashforge",     "FLSun",
                                                         "FlyingBear",     "Folgertech",
                                                         "Geeetech",       "Ginger Additive",
                                                         "InfiMech",       "Kingroon",
                                                         "Lulzbot",        "MagicMaker",
                                                         "Mellow",         "Orca Arena Printer",
                                                         "Peopoly",        "Positron 3D",
                                                         "Prusa",          "Qidi",
                                                         "Raise3D",        "RatRig",
                                                         "RolohaunDesign", "SecKit",
                                                         "Snapmaker",      "Sovol",
                                                         "Thinker X400",   "Tronxy",
                                                         "TwoTrees",       "UltiMaker",
                                                         "Vivedino",       "Volumic",
...
static const std::unordered_map<std::string, std::vector<std::string>> printer_model_map =
    {{"Anker", {"Anker M5", "Anker M5 All-Metal Hot End", "Anker M5C"}},
     ...
     {"Artillery",
      {"Artillery Sidewinder X1", "Artillery Genius", "Artillery Genius Pro", "Artillery Sidewinder X2", "Artillery Hornet",
       "Artillery Sidewinder X3 Pro", "Artillery Sidewinder X3 Plus", "Artillery Sidewinder X4 Pro", "Artillery Sidewinder X4 Plus"}},
     {"Bambulab",
      {"Bambu Lab X1 Carbon", "Bambu Lab X1", "Bambu Lab X1E", "Bambu Lab P1P", "Bambu Lab P1S", "Bambu Lab A1 mini", "Bambu Lab A1"}},
     ...
     {"Elegoo",
      {"Elegoo Centauri Carbon", "Elegoo Centauri", "Elegoo Neptune", "Elegoo Neptune X", "Elegoo Neptune 2", "Elegoo Neptune 2S",
       "Elegoo Neptune 2D", "Elegoo Neptune 3", "Elegoo Neptune 3 Pro", "Elegoo Neptune 3 Plus", "Elegoo Neptune 3 Max",
       "Elegoo Neptune 4 Pro", "Elegoo Neptune 4", "Elegoo Neptune 4 Max", "Elegoo Neptune 4 Plus", "Elegoo OrangeStorm Giga"}},
     {"Flashforge",
      {"Flashforge Adventurer 5M", "Flashforge Adventurer 5M Pro", "Flashforge AD5X", "Flashforge Adventurer 3 Series",
       "Flashforge Adventurer 4 Series", "Flashforge Guider 3 Ultra", "Flashforge Guider 2s"}},
     {"FLSun", {"FLSun Q5", "FLSun QQ-S Pro", "FLSun Super Racer (SR)", "FLSun V400", "FLSun T1", "FLSun S1"}},
     {"FlyingBear", {"FlyingBear Reborn3", "FlyingBear S1", "FlyingBear Ghost 6"}},
     {"Folgertech", {"Folgertech i3", "Folgertech FT-5", "Folgertech FT-6"}},
     {"Geeetech",
      {"Geeetech Thunder", "Geeetech Mizar M", "Geeetech Mizar S", "Geeetech Mizar Pro", "Geeetech Mizar Max", "Geeetech Mizar",
       "Geeetech A10 Pro", "Geeetech A10 M", "Geeetech A10 T", "Geeetech A20", "Geeetech A20 M", "Geeetech A20 T", "Geeetech A30 Pro",
       "Geeetech A30 M", "Geeetech A30 T", "Geeetech M1"}},
     ...
     {"Prusa",
      {"Prusa CORE One", "Prusa CORE One HF", "Prusa CORE One L", "Prusa CORE One L HF", "MK4IS", "MK4S", "MK4S HF", "Prusa XL",
       "Prusa XL 5T", "MK3.5", "MK3S", "MINI", "MINIIS"}},
     {"Qidi",
      {"Qidi X-Plus 4", "Qidi Q1 Pro", "Qidi X-Max 3", "Qidi X-Plus 3", "Qidi X-Smart 3", "Qidi X-Plus", "Qidi X-Max", "Qidi X-CF Pro"}},
     ...
     {"RatRig",
      {"RatRig V-Core 3 200",
       ...
       "RatRig V-Core 4 400",
       "RatRig V-Core 4 500",
       "RatRig V-Core 4 HYBRID 300",
       "RatRig V-Core 4 HYBRID 400",
       "RatRig V-Core 4 HYBRID 500",
       "RatRig V-Core 4 IDEX 300",
       "RatRig V-Core 4 IDEX 300 COPY MODE",
       "RatRig V-Core 4 IDEX 300 MIRROR MODE",
       "RatRig V-Core 4 IDEX 400",
       "RatRig V-Core 4 IDEX 400 COPY MODE",
       "RatRig V-Core 4 IDEX 400 MIRROR MODE",
     ...
     {"Snapmaker",
      {"Snapmaker J1", "Snapmaker A250", "Snapmaker A350", "Snapmaker A250 Dual", "Snapmaker A350 Dual", "Snapmaker A250 QSKit",
       "Snapmaker A350 QSKit", "Snapmaker A250 BKit", "Snapmaker A350 BKit", "Snapmaker A250 QS+B Kit", "Snapmaker A350 QS+B Kit",
       "Snapmaker A250 Dual QSKit", "Snapmaker A350 Dual QSKit", "Snapmaker A250 Dual BKit", "Snapmaker A350 Dual BKit",
       "Snapmaker A250 Dual QS+B Kit", "Snapmaker A350 Dual QS+B Kit", "Snapmaker Artisan"}},
     {"Sovol",
      {"Sovol SV01 Pro", "Sovol SV02", "Sovol SV05", "Sovol SV06", "Sovol SV06 Plus", "Sovol SV06 ACE", "Sovol SV06 Plus ACE", "Sovol SV07",
       "Sovol SV07 Plus", "Sovol SV08"}},
     ...
     {"Volumic",
      {"EXO42 Performance", "EXO65 Performance", "SH65 Performance", "EXO42", "EXO65", "SH65", "VS30SC2", "VS30SC", "VS30ULTRA", "VS30MK3",
       "VS30MK2", "VS20MK2"}},
     {"Voron",
      {"Voron 2.4 250", "Voron 2.4 300", "Voron 2.4 350", "Voron Trident 250", "Voron Trident 300", "Voron Trident 350", "Voron 0.1",
       "Voron Switchwire 250"}},
     {"Voxelab", {"Voxelab Aquila X2"}},
     {"Vzbot", {"Vzbot 235 AWD", "Vzbot 330 AWD"}},
     {"Wanhao", {"Wanhao D12-300"}},
     {"Z-Bolt", {"Z-Bolt S300", "Z-Bolt S300 Dual", "Z-Bolt S400", "Z-Bolt S400 Dual", "Z-Bolt S600", "Z-Bolt S600 Dual"}}};

static std::vector<std::string>               nozzle_diameter_vec = {"0.4", "0.15", "0.2",  "0.25", "0.3", "0.35",
                                                                     "0.5", "0.6",  "0.75", "0.8",  "1.0", "1.2"};
...
static float my_stof(std::string str)
{
    ...
    if (alt_pos != std::string::npos) {
        str.replace(alt_pos, 1, 1, dec_sep);
    }

    if (str == std::string(1, dec_sep)) {
        return 0.0f;
    }
...
static bool delete_filament_preset_by_name(std::string delete_preset_name, std::string& selected_preset_name)
{
    ...
    if (delete_preset_name == selected_preset_name) {
        ...
        if (idx_current > presets.size())
            idx_current = presets.size();
        if (idx_current < 0)
            idx_current = 0;
        if (idx_new < presets.size())
            for (; idx_new < presets.size() && (presets[idx_new].name == delete_preset_name || !presets[idx_new].is_visible); ++idx_new)
                ;
        if (idx_new == presets.size())
            for (idx_new = idx_current - 1; idx_new > 0 && (presets[idx_new].name == delete_preset_name || !presets[idx_new].is_visible);
                 --idx_new)
                ;
        selected_preset_name = presets[idx_new].name;
        BOOST_LOG_TRIVIAL(info) << boost::format("cause by delete current ,choose the next visible, idx %1%, name %2%") % idx_new %
    ...
    try {
        ...
        if (!need_delete_preset)
            BOOST_LOG_TRIVIAL(info) << __FUNCTION__ << boost::format(" can't find delete preset and name: %1%") % delete_preset_name;
        if (!need_delete_preset->setting_id.empty()) {
            BOOST_LOG_TRIVIAL(info) << "delete preset = " << need_delete_preset->name
                                    << ", setting_id = " << need_delete_preset->setting_id;
        ...
        BOOST_LOG_TRIVIAL(info) << __FUNCTION__
                                << boost::format("found exception when delete: %1% and preset name: %%") % ex.what() % delete_preset_name;
        return false;
    }
...
static wxBoxSizer* create_checkbox(wxWindow*                                     parent,
                                   Preset*                                       preset,
                                   wxString&                                     preset_name,
                                   std::vector<std::pair<::CheckBox*, Preset*>>& preset_checkbox)
{
...
static wxBoxSizer* create_checkbox(wxWindow*                                                         parent,
                                   ...
                                   Preset*                                                           preset,
                                   std::unordered_map<::CheckBox*, std::pair<std::string, Preset*>>& ptinter_compatible_filament_preset)
{
    wxBoxSizer* sizer    = new wxBoxSizer(wxHORIZONTAL);
    ::CheckBox* checkbox = new ::CheckBox(parent);
    sizer->Add(checkbox, 0, 0, 0);
...
static wxBoxSizer* create_checkbox(wxWindow*                                         parent,
                                   wxString&                                         preset_name,
                                   std::vector<std::pair<::CheckBox*, std::string>>& preset_checkbox)
{
    wxBoxSizer* sizer    = new wxBoxSizer(wxHORIZONTAL);
    ::CheckBox* checkbox = new ::CheckBox(parent);
    sizer->Add(checkbox, 0, 0, 0);
...
static std::string get_filament_id(std::string vendor_typr_serial)
{
    ...
    for (std::pair<std::string, std::vector<Preset const*>> filament_id_to_presets : temp_filament_id_to_presets) {
        if (filament_id_to_presets.first.empty())
            continue;
    ...
    BOOST_LOG_TRIVIAL(info) << __FUNCTION__ << " filament name is: " << vendor_typr_serial
                            << "and create filament_id is: " << user_filament_id;
...
// [INTENT] Modal dialog for creating a new filament profile.
// [STATE] Manages selections for vendor, type, serial, and compatible printers.
// [UNITY] Map to VisualElement-based ModalWindow with data-bound ComboBoxes.
                ...
                wxCAPTION | wxCLOSE_BOX | wxCENTRE | wxRESIZE_BORDER)
{
    ...
    m_filament_preset_text = new wxStaticText(this, wxID_ANY, _L("We could create the filament presets for your following printer:"),
...
void CreateFilamentPresetDialog::on_dpi_changed(const wxRect& suggested_rect) { Layout(); }
...
wxBoxSizer* CreateFilamentPresetDialog::create_vendor_item()
{
    ...
    m_filament_vendor_combobox = new ComboBox(this, wxID_ANY, wxEmptyString, wxDefaultPosition, NAME_OPTION_COMBOBOX_SIZE, 0, nullptr,
                                              wxCB_READONLY);
    ...
    m_filament_custom_vendor_input = new TextInput(this, wxEmptyString, wxEmptyString, wxEmptyString, wxDefaultPosition,
                                                   NAME_OPTION_COMBOBOX_SIZE, wxTE_PROCESS_ENTER);
    ...
    wxStaticText* m_can_not_find_vendor_text = new wxStaticText(this, wxID_ANY, _L("Can't find vendor I want"), wxDefaultPosition,
                                                                wxDefaultSize, 0);
...
wxBoxSizer* CreateFilamentPresetDialog::create_type_item()
{
    ...
    wxBoxSizer* comboBoxSizer = new wxBoxSizer(wxVERTICAL);
    m_filament_type_combobox  = new ComboBox(this, wxID_ANY, wxEmptyString, wxDefaultPosition, NAME_OPTION_COMBOBOX_SIZE, 0, nullptr,
                                             wxCB_READONLY);
...
wxBoxSizer* CreateFilamentPresetDialog::create_filament_preset_item()
{
    ...
    m_filament_preset_combobox = new ComboBox(this, wxID_ANY, wxEmptyString, wxDefaultPosition, FILAMENT_PRESET_COMBOBOX_SIZE, 0, nullptr,
                                              wxCB_READONLY);
    m_filament_preset_combobox->SetLabel(_L("Select Filament Preset"));
    m_filament_preset_combobox->SetLabelColor(DEFAULT_PROMPT_TEXT_COLOUR);
    ...
    m_filament_preset_combobox->Bind(wxEVT_COMBOBOX, [this](wxCommandEvent& e) {
        ...
        std::unordered_map<std::string, std::vector<Preset*>>::iterator iter          = m_filament_choice_map.find(
            m_public_name_to_filament_id_map[filament_type]);
        ...
        if (iter != m_filament_choice_map.end()) {
            ...
            for (Preset* preset : iter->second) {
                ...
                if (!compatible_printers || compatible_printers->values.empty()) {
                    BOOST_LOG_TRIVIAL(info) << __FUNCTION__
                                            << "there is a preset has no compatible printers and the preset name is: " << preset->name;
                ...
                for (std::string& compatible_printer_name : compatible_printers->values) {
                    ...
                    if (nozzle_diameter[nozzle] == 0) {
                        BOOST_LOG_TRIVIAL(info)
                            << __FUNCTION__ << " compatible printer nozzle encounter exception and name is: " << compatible_printer_name;
                        continue;
                    }
                    printer_name_to_filament_preset.push_back(std::make_pair(compatible_printer_name, preset));
                    BOOST_LOG_TRIVIAL(info) << __FUNCTION__ << "show compatible printer name: " << compatible_printer_name
                                            << "and preset name is: " << preset;
                }
            }
        } else {
        ...
        for (std::pair<std::string, Preset*> printer_to_preset : printer_name_to_filament_preset)
            m_filament_presets_sizer->Add(create_checkbox(m_filament_preset_panel, printer_to_preset.first, printer_to_preset.second,
                                                          m_filament_preset),
                                          0, wxEXPAND | wxTOP | wxLEFT, FromDIP(5));
        m_scrolled_preset_panel->SetSizerAndFit(m_scrolled_sizer);
    ...
    comboBoxSizer->Add(create_radio_item(m_create_type.base_filament_preset, this, wxEmptyString, m_create_type_btns), 0, wxEXPAND | wxTOP,
                       FromDIP(10));
    ...
    btn_ok->Bind(wxEVT_BUTTON, [this](wxCommandEvent& e) {
        ...
        if (!m_can_not_find_vendor_checkbox->GetValue()) {
            if (_L("Select Vendor") == vendor_str) {
                MessageDialog dlg(this, _L("Vendor is not selected, please reselect vendor."),
            ...
            if (m_filament_custom_vendor_input->GetTextCtrl()->GetValue().empty()) {
                MessageDialog dlg(this, _L("Custom vendor is not input, please input custom vendor."),
                                  wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES | wxYES_DEFAULT | wxCENTRE);
                dlg.ShowModal();
                return;
            } else {
                ...
                if (vendor_name == "Bambu" || vendor_name == "Generic") {
                    MessageDialog dlg(this, _L("\"Bambu\" or \"Generic\" cannot be used as a Vendor for custom filaments."),
                                      wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES | wxYES_DEFAULT | wxCENTRE);
                    dlg.ShowModal();
                    return;
                }
        ...
        if (_L("Select Type") == type_str) {
            MessageDialog dlg(this, _L("Filament type is not selected, please reselect type."),
                              wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES | wxYES_DEFAULT | wxCENTRE);
            dlg.ShowModal();
            return;
        } else {
        ...
        if (serial_str.empty()) {
            MessageDialog dlg(this, _L("Filament serial is not entered, please enter serial."),
                              wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES | wxYES_DEFAULT | wxCENTRE);
            dlg.ShowModal();
            return;
        } else {
        ...
        if (m_can_not_find_vendor_checkbox->GetValue() && str_is_all_digit(vendor_name)) {
            MessageDialog dlg(this, _L("The vendor cannot be a number. Please re-enter."),
                              wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES | wxYES_DEFAULT | wxCENTRE);
            dlg.ShowModal();
            return;
        }
        ...
        if (!is_check_box_selected()) {
            MessageDialog dlg(this, _L("You have not selected a printer or preset yet. Please select at least one."),
                              wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES | wxYES_DEFAULT | wxCENTRE);
            dlg.ShowModal();
            return;
        }
        ...
        if (curr_create_type == m_create_type.base_filament) {
            ...
            for (const auto& checkbox_preset : m_filament_preset) {
                if (checkbox_preset.first->GetValue()) {
                    ...
                    // [PORTING_HAZARD:P2] Direct mutation of preset bundle from UI event handler.
                    // [UNITY] Use a command pattern or service method to perform cloning.
                    bool res = preset_bundle->filaments.clone_presets_for_filament(checked_preset, failures, filament_preset_name,
                                                                                   user_filament_id, dynamic_config,
                    ...
                    if (!res) {
                        ...
                        MessageDialog dlg(this,
                                          _L("Some existing presets have failed to be created, as follows:\n") + from_u8(failure_names) +
                                              _L("\nDo you want to rewrite it?"),
                                          wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES_NO | wxYES_DEFAULT | wxCENTRE);
                        if (dlg.ShowModal() == wxID_YES) {
                            res = preset_bundle->filaments.clone_presets_for_filament(checked_preset, failures, filament_preset_name,
                                                                                      user_filament_id, dynamic_config,
            ...
            for (const auto& checkbox_preset : m_machint_filament_preset) {
                if (checkbox_preset.first->GetValue()) {
                    ...
                    BOOST_LOG_TRIVIAL(info) << "clone filament presets  no failures  is successful? " << res
                                            << " old preset is: " << checked_preset->name
...
wxArrayString CreateFilamentPresetDialog::get_filament_preset_choices()
{
    ...
    std::string type_name;
    if (_L("Select Type") == type_str) {
        /*MessageDialog dlg(this, _L("Filament type is not selected, please reselect type."), wxString(SLIC3R_APP_FULL_NAME) + " - " +
        _L("Info"), wxYES | wxYES_DEFAULT | wxCENTRE); dlg.ShowModal();*/
        return choices;
    } else {
        type_name = into_u8(type_str);
    }
    ...
    for (std::pair<std::string, Preset*> filament_presets : m_all_presets_map) {
        ...
        if (!fila_type || fila_type->values.empty() || type_name != fila_type->values[0])
            continue;
    ...
    for (const auto& preset : m_filament_choice_map) {
        ...
        for (Preset* filament_preset : preset.second) {
            ...
            BOOST_LOG_TRIVIAL(info) << __FUNCTION__ << " filament_id: " << filament_preset->filament_id
                                    << " preset name: " << filament_preset->name;
...
wxBoxSizer* CreateFilamentPresetDialog::create_radio_item(wxString                                     title,
                                                          wxWindow*                                    parent,
                                                          wxString                                     tooltip,
                                                          std::vector<std::pair<RadioBox*, wxString>>& radiobox_list)
{
    wxBoxSizer* horizontal_sizer = new wxBoxSizer(wxHORIZONTAL);
...
void CreateFilamentPresetDialog::get_filament_presets_by_machine()
{
    ...
    for (std::pair<std::string, Preset*> filament_preset : m_all_presets_map) {
        ...
        for (std::string& compatible_printer_name : compatible_printers->values) {
            ...
            if (nozzle_diameter[nozzle] == 0) {
                BOOST_LOG_TRIVIAL(info) << __FUNCTION__
                                        << " compatible printer nozzle encounter exception and name is: " << compatible_printer_name;
                continue;
            }
    ...
    for (std::pair<std::string, std::vector<Preset*>> machine_filament_presets : printer_name_to_filament_presets) {
        ...
        m_filament_presets_sizer->Add(create_select_filament_preset_checkbox(m_filament_preset_panel, compatible_printer, presets,
                                                                             m_machint_filament_preset),
                                      0, wxEXPAND | wxALL, FromDIP(5));
    }
...
void CreateFilamentPresetDialog::get_all_filament_presets()
{
    ...
    for (const Preset& preset : filament_presets) {
        if (preset.filament_id.empty() || "null" == preset.filament_id)
            continue;
    ...
    std::sort(printer_name_to_filament_preset.begin(), printer_name_to_filament_preset.end(),
              [&nozzle_diameter](const std::pair<string, T>& a, const std::pair<string, T>& b) {
                  ...
                  if (nozzle_a == nozzle_b)
                      return a.first < b.first;
                  if (diff_nozzle_a == diff_nozzle_b)
...
// [INTENT] Modal dialog for creating a new printer or adding a nozzle to an existing one.
// [STATE] Two-page wizard: 1) Basic printer info (nozzle, bed shape), 2) Selection of base templates for filament/process presets.
// [UNITY] Use a two-step Wizard component or separate VisualElement pages in a single ModalWindow.
CreatePrinterPresetDialog::CreatePrinterPresetDialog(wxWindow* parent)
    : DPIDialog(parent ? parent : nullptr,
                wxID_ANY,
                _L("Create Printer/Nozzle"),
                wxDefaultPosition,
                wxDefaultSize,
                wxCAPTION | wxCLOSE_BOX | wxCENTER)
{
...
void CreatePrinterPresetDialog::on_dpi_changed(const wxRect& suggested_rect) { Layout(); }
...
wxBoxSizer* CreatePrinterPresetDialog::create_step_switch_item()
{
    ...
    // wxHyperlinkCtrl *m_download_hyperlink = new wxHyperlinkCtrl(this, wxID_ANY, _L("wiki"), wiki_url, wxDefaultPosition, wxDefaultSize,
    // wxHL_DEFAULT_STYLE); step_switch_sizer->Add(m_download_hyperlink, 0,  wxRIGHT | wxALIGN_RIGHT, FromDIP(5));
    ...
    m_step_1 = new wxStaticBitmap(step_switch_panel, wxID_ANY, create_scaled_bitmap("step_1", nullptr, FromDIP(20)), wxDefaultPosition,
                                  wxDefaultSize);
    horizontal_sizer->Add(m_step_1, 0, wxEXPAND | wxLEFT | wxRIGHT | wxALIGN_CENTER_VERTICAL, FromDIP(3));
    wxStaticText* static_create_printer_text = new wxStaticText(step_switch_panel, wxID_ANY, m_create_type.create_printer,
                                                                wxDefaultPosition, wxDefaultSize);
    ...
    m_step_2 = new wxStaticBitmap(step_switch_panel, wxID_ANY, create_scaled_bitmap("step_2_ready", nullptr, FromDIP(20)),
                                  wxDefaultPosition, wxDefaultSize);
    horizontal_sizer->Add(m_step_2, 0, wxEXPAND | wxLEFT | wxRIGHT | wxALIGN_CENTER_VERTICAL, FromDIP(3));
    wxStaticText* static_import_presets_text = new wxStaticText(step_switch_panel, wxID_ANY, _L("Import Preset"), wxDefaultPosition,
                                                                wxDefaultSize);
...
wxBoxSizer* CreatePrinterPresetDialog::create_type_item(wxWindow* parent)
{
    ...
    radioBoxSizer->Add(create_radio_item(m_create_type.create_nozzle, parent, wxEmptyString, m_create_type_btns), 0, wxEXPAND | wxTOP,
                       FromDIP(10));
...
wxBoxSizer* CreatePrinterPresetDialog::create_printer_item(wxWindow* parent)
{
    ...
    m_select_vendor->Bind(wxEVT_COMBOBOX, [this](wxCommandEvent e) {
        ...
        if (iter != printer_model_map.end()) {
            ...
            MessageDialog dlg(this, _L("The model was not found, please reselect vendor."),
                              wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES | wxYES_DEFAULT | wxCENTRE);
            dlg.ShowModal();
        }
    ...
    m_select_printer = new ComboBox(parent, wxID_ANY, wxEmptyString, wxDefaultPosition, PRINTER_PRESET_MODEL_SIZE, 0, nullptr,
                                    wxCB_READONLY);
...
wxBoxSizer* CreatePrinterPresetDialog::create_nozzle_diameter_item(wxWindow* parent)
{
    ...
    for (const std::string& nozzle : nozzle_diameter_vec) {
        ...
        if (pos != std::string::npos) {
            display_nozzle.replace(pos, 1, 1, dec_sep);
        }
    ...
    auto can_not_find_nozzle_diameter = new wxStaticText(parent, wxID_ANY, _L("Can't find my nozzle diameter"), wxDefaultPosition,
                                                         wxDefaultSize, 0);
...
wxBoxSizer* CreatePrinterPresetDialog::create_max_print_height_item(wxWindow* parent)
{
    ...
    m_print_height_input          = new TextInput(parent, "200", _L("mm"), wxEmptyString, wxDefaultPosition, PRINTER_SPACE_SIZE,
                                                  wxTE_PROCESS_ENTER); // Use same alignment with all other input boxes
    wxTextValidator validator(wxFILTER_DIGITS);
...
{
    wxFileDialog dialog(this, _L("Choose a file to import bed texture from (PNG/SVG):"), last_directory, "", file_wildcards(FT_TEX),
    ...
    if (Utils::is_file_too_large(file_name, try_ok)) {
        if (try_ok) {
            m_upload_svg_tip_text->SetLabelText(
                wxString::Format(_L("The file exceeds %d MB, please import again."), STL_SVG_MAX_FILE_SIZE_MB));
        } else {
...
{
    wxFileDialog dialog(this, _L("Choose an STL file to import bed model from:"), last_directory, "", file_wildcards(FT_STL),
                        wxFD_OPEN | wxFD_FILE_MUST_EXIST);
    ...
    if (Utils::is_file_too_large(file_name, try_ok)) {
        if (try_ok) {
            m_upload_stl_tip_text->SetLabelText(
                wxString::Format(_L("The file exceeds %d MB, please import again."), STL_SVG_MAX_FILE_SIZE_MB));
        } else {
...
bool CreatePrinterPresetDialog::load_system_and_user_presets_with_curr_model(PresetBundle& temp_preset_bundle, bool just_template)
{
    ...
    if (m_printer_preset_vendor_selected.id.empty() || m_printer_preset_model_selected.id.empty()) {
        ...
        MessageDialog dlg(this, _L("Preset path was not found, please reselect vendor."),
                          wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES_NO | wxYES_DEFAULT | wxCENTRE);
        dlg.ShowModal();
        return false;
    }
    ...
    if (PRESET_CUSTOM_VENDOR == m_printer_preset_vendor_selected.name || PRESET_CUSTOM_VENDOR == m_printer_preset_vendor_selected.id) {
        ...
        try {
            ...
            MessageDialog dlg(this, _L("The printer model was not found, please reselect."),
                              wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES_NO | wxYES_DEFAULT | wxCENTRE);
            dlg.ShowModal();
            return false;
        }
    ...
    if (index_at != std::string::npos && index_nozzle != std::string::npos) {
        ...
        MessageDialog dlg(this, _L("The nozzle diameter was not found, please reselect."),
                          wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES_NO | wxYES_DEFAULT | wxCENTRE);
        dlg.ShowModal();
        return false;
    }

    const Preset* temp_printer_preset =
        is_custom_vendor ?
            temp_preset_bundle.printers.find_custom_preset_by_model_and_variant(m_printer_preset_model_selected.id, varient) :
    ...
    if (temp_printer_preset) {
        ...
        MessageDialog dlg(this, _L("The printer preset was not found, please reselect."),
                          wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES_NO | wxYES_DEFAULT | wxCENTRE);
        dlg.ShowModal();
        return false;
    }
    ...
    if (!just_template) {
        ...
        preset_path.clear();
        if (boost::filesystem::exists(boost::filesystem::path(Slic3r::resources_dir()) / PRESET_PROFILES_TEMOLATE_DIR /
                                      selected_vendor_id)) {
...
void CreatePrinterPresetDialog::generate_process_presets_data(std::vector<Preset const*> presets, std::string nozzle)
{
    ...
    for (const Preset* preset : presets) {
        ...
        auto initial_layer_print_height = dynamic_cast<ConfigOptionFloat*>(
            const_cast<Preset*>(preset)->config.option("initial_layer_print_height", true));
        ...
        auto initial_layer_line_width = dynamic_cast<ConfigOptionFloat*>(
            const_cast<Preset*>(preset)->config.option("initial_layer_line_width", true));
        ...
        auto outer_wall_line_width = dynamic_cast<ConfigOptionFloat*>(
            const_cast<Preset*>(preset)->config.option("outer_wall_line_width", true));
        ...
        auto inner_wall_line_width = dynamic_cast<ConfigOptionFloat*>(
            const_cast<Preset*>(preset)->config.option("inner_wall_line_width", true));
        ...
        auto top_surface_line_width = dynamic_cast<ConfigOptionFloat*>(
            const_cast<Preset*>(preset)->config.option("top_surface_line_width", true));
        ...
        auto sparse_infill_line_width = dynamic_cast<ConfigOptionFloat*>(
            const_cast<Preset*>(preset)->config.option("sparse_infill_line_width", true));
        ...
        auto internal_solid_infill_line_width = dynamic_cast<ConfigOptionFloat*>(
            const_cast<Preset*>(preset)->config.option("internal_solid_infill_line_width", true));
...
std::string CreatePrinterPresetDialog::get_nozzle_diameter() const
{
    ...
    if (m_can_not_find_nozzle_checkbox->GetValue()) {
        ...
        if (std::string::npos != index_mm) {
            diameter = diameter.substr(0, index_mm);
        }
    }
    float nozzle = 0;
    try {
...
std::string CreatePrinterPresetDialog::get_custom_printer_model() const
{
    ...
    if (curr_selected_printer_type == m_create_type.create_printer) {
        ...
        std::unordered_map<std::string, std::shared_ptr<Preset>>::const_iterator itor = m_printer_name_to_preset.find(
            selected_printer_preset_name);
        ...
        if (m_printer_name_to_preset.end() != itor) {
            ...
            try {
                ...
                BOOST_LOG_TRIVIAL(info) << __FUNCTION__
                                        << " get config printer_model or , and the name is: " << selected_printer_preset_name;
            }
...
wxBoxSizer* CreatePrinterPresetDialog::create_radio_item(wxString                                     title,
                                                         wxWindow*                                    parent,
                                                         wxString                                     tooltip,
                                                         std::vector<std::pair<RadioBox*, wxString>>& radiobox_list)
{
...
wxBoxSizer* CreatePrinterPresetDialog::create_printer_preset_item(wxWindow* parent)
{
    ...
    m_printer_vendor           = new ComboBox(parent, wxID_ANY, wxEmptyString, wxDefaultPosition, PRINTER_PRESET_VENDOR_SIZE, 0, nullptr,
                                              wxCB_READONLY);
...
wxBoxSizer* CreatePrinterPresetDialog::create_presets_item(wxWindow* parent)
{
    ...
    radioBoxSizer->Add(create_radio_item(m_create_type.base_curr_printer, parent, wxEmptyString, m_create_presets_btns), 0,
...
wxBoxSizer* CreatePrinterPresetDialog::create_presets_template_item(wxWindow* parent)
{
    ...
    wxStaticText* static_filament_preset_text = new wxStaticText(m_preset_template_panel, wxID_ANY, _L("Filament Preset Template"),
                                                                 wxDefaultPosition, wxDefaultSize);
    ...
    wxStaticText* filament_desel_all_text = new wxStaticText(filament_btn_panel, wxID_ANY, _L("Deselect All"), wxDefaultPosition,
                                                             wxDefaultSize);
    ...
    wxStaticText* static_process_preset_text = new wxStaticText(m_preset_template_panel, wxID_ANY, _L("Process Preset Template"),
                                                                wxDefaultPosition, wxDefaultSize);
    ...
    wxStaticText* process_desel_all_text = new wxStaticText(process_btn_panel, wxID_ANY, _L("Deselect All"), wxDefaultPosition,
                                                            wxDefaultSize);
...
wxWindow* CreatePrinterPresetDialog::create_page2_dialog_buttons(wxWindow* parent)
{
    ...
    btn_ok->Bind(wxEVT_BUTTON, [this](wxCommandEvent& e) {
        ...
        if (!m_printer_preset) {
            MessageDialog dlg(
                this,
                _L("You have not yet chosen which printer preset to create based on. Please choose the vendor and model of the printer"),
                wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES | wxYES_DEFAULT | wxCENTRE);
            dlg.ShowModal();
            return;
        }
        ...
        if (!save_printable_area_config(m_printer_preset)) {
            MessageDialog dlg(
                this,
                _L("You have entered an illegal input in the printable area section on the first page. Please check before creating it."),
                wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES | wxYES_DEFAULT | wxCENTRE);
            dlg.ShowModal();
            show_page1();
            return;
        ...
        for (std::pair<::CheckBox*, Preset const*> filament_preset : m_filament_preset) {
            ...
            if (!filament_preset_is_exist &&
                preset_bundle->filaments.find_preset(filament_preset.second->alias + " @ " + printer_preset_name) != nullptr) {
                filament_preset_is_exist = true;
            }
        }
        if (selected_filament_presets.empty() && !filament_preset_is_exist) {
            MessageDialog dlg(this, _L("You need to select at least one filament preset."),
                              wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES | wxYES_DEFAULT | wxCENTRE);
            dlg.ShowModal();
            return;
        }
        ...
        for (std::pair<::CheckBox*, Preset const*> process_preset : m_process_preset) {
            ...
            if (!process_preset_is_exist &&
                preset_bundle->prints.find_preset(process_preset.second->alias + " @" + printer_preset_name) != nullptr) {
                process_preset_is_exist = true;
            }
        }
        if (selected_process_presets.empty() && !process_preset_is_exist) {
            MessageDialog dlg(this, _L("You need to select at least one process preset."),
                              wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES | wxYES_DEFAULT | wxCENTRE);
            dlg.ShowModal();
            return;
        }
        ...
        if (curr_selected_preset_type == m_create_type.base_template) {
            ...
            if (!selected_filament_presets.empty()) {
                bool create_preset_result = preset_bundle->filaments.clone_presets_for_printer(selected_filament_presets, failures,
                                                                                               printer_preset_name, get_filament_id,
                                                                                               rewritten);
                if (!create_preset_result) {
                    ...
                    MessageDialog dlg(this,
                                      _L("Create filament presets failed. As follows:\n") + from_u8(message) +
                                          _L("\nDo you want to rewrite it?"),
                                      wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES | wxYES_DEFAULT | wxCENTRE);
                    int           res = dlg.ShowModal();
                    if (wxID_YES == res) {
                        create_preset_result = preset_bundle->filaments.clone_presets_for_printer(selected_filament_presets, failures,
                                                                                                  printer_preset_name, get_filament_id,
                                                                                                  true);
                    } else {
                        BOOST_LOG_TRIVIAL(info)
                            << __FUNCTION__
                            << " printer preset no same preset but filament has same preset, user cancel create the printer preset";
                        return;
                    }
                }
                // save created successfully preset name
                for (Preset const* sucessful_preset : selected_filament_presets)
                    successful_preset_names.push_back(sucessful_preset->name.substr(0, sucessful_preset->name.find(" @")) + " @" +
                                                      printer_preset_name);
            }
            ...
            if (!selected_process_presets.empty()) {
                ...
                bool create_preset_result = preset_bundle->prints.clone_presets_for_printer(selected_process_presets, failures,
                                                                                            printer_preset_name, get_filament_id,
                                                                                            rewritten);
                if (!create_preset_result) {
                    std::string message;
                    ...
                    MessageDialog dlg(this,
                                      _L("Create process presets failed. As follows:\n") + from_u8(message) +
                                          _L("\nDo you want to rewrite it?"),
                                      wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES | wxYES_DEFAULT | wxCENTRE);
                    int           res = dlg.ShowModal();
                    if (wxID_YES == res) {
                        create_preset_result = preset_bundle->prints.clone_presets_for_printer(selected_process_presets, failures,
                                                                                               printer_preset_name, get_filament_id, true);
                    } else {
                        BOOST_LOG_TRIVIAL(info)
                            << __FUNCTION__
                            << " printer preset no same preset but process has same preset, user cancel create the printer preset";
                        return;
                    }
                }
            }
        ...
        try {
            ...
            BOOST_LOG_TRIVIAL(info) << __FUNCTION__
                                    << " bisic info is not rewritten, may be printer_model, printer_variant, or nozzle_diameter";
        }
...
void CreatePrinterPresetDialog::on_select_printer_model(wxCommandEvent& e)
{
    ...
    if (iterator != vendors.end()) {
        ...
        MessageDialog dlg(this, _L("Vendor was not found, please reselect."), wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"),
    ...
    if (printer_preset_model.size() == 0) {
        MessageDialog dlg(this, _L("Current vendor has no models, please reselect."), wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"),
...
void CreatePrinterPresetDialog::set_current_visible_printer()
{
    ...
    if (m_printer_name_to_preset.size() > 0)
        return;
    PresetBundle*             preset_bundle   = wxGetApp().preset_bundle;
    ...
    for (const Preset& printer_preset : printer_presets) {
        if (!printer_preset.is_visible)
            continue;
        if (preset_bundle->printers.get_preset_base(printer_preset)->name != printer_preset.name)
            continue;
        if (auto printer_model = dynamic_cast<ConfigOptionString*>(
                const_cast<Preset&>(printer_preset).config.option("printer_model", false))) {
...
wxArrayString CreatePrinterPresetDialog::printer_preset_sort_with_nozzle_diameter(const VendorProfile& vendor_profile, float nozzle_diameter)
{
    ...
    std::sort(preset_sort.begin(), preset_sort.end(),
...
{
    PresetBundle temp_preset_bundle;
    if (!load_system_and_user_presets_with_curr_model(temp_preset_bundle, just_template))
        return;
    ...
    for (const Preset& filament_preset : filament_presets) {
        if (filament_preset.is_compatible) {
            if (filament_preset.is_default)
                continue;
            Preset*  temp_filament = new Preset(filament_preset);
            wxString filament_name = wxString::FromUTF8(temp_filament->name);
            m_filament_preset_template_sizer->Add(create_checkbox(m_filament_preset_panel, temp_filament, filament_name, m_filament_preset),
                                                  0, wxEXPAND, FromDIP(5));
        }
    }

    for (const Preset& process_preset : process_presets) {
        if (process_preset.is_compatible) {
            if (process_preset.is_default)
                continue;

            Preset*  temp_process = new Preset(process_preset);
            wxString process_name = wxString::FromUTF8(temp_process->name);
            m_process_preset_template_sizer->Add(create_checkbox(m_process_preset_panel, temp_process, process_name, m_process_preset), 0,
                                                 wxEXPAND, FromDIP(5));
        }
    }
...
bool CreatePrinterPresetDialog::save_printable_area_config(Preset* preset)
{
    ...
    if (curr_selected_printer_type == m_create_type.create_printer) {
        ...
        std::string selected_printer_preset_name                                = into_u8(m_select_printer->GetStringSelection());
        std::unordered_map<std::string, std::shared_ptr<Preset>>::iterator itor = m_printer_name_to_preset.find(
            selected_printer_preset_name);
        assert(m_printer_name_to_preset.end() != itor);
        if (m_printer_name_to_preset.end() != itor) {
            std::shared_ptr<Preset>  printer_preset = itor->second;
...
bool CreatePrinterPresetDialog::validate_input_valid()
{
    ...
    if (curr_selected_printer_type == m_create_type.create_printer) {
        ...
        if ((vendor_name.empty() || model_name.empty())) {
            MessageDialog dlg(this, _L("You have not selected the vendor and model or entered the custom vendor and model."),
                              wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES | wxYES_DEFAULT | wxCENTRE);
            dlg.ShowModal();
            return false;
        }
        ...
        if (vendor_name.empty() || model_name.empty()) {
            MessageDialog dlg(this, _L("All inputs in the custom printer vendor or model are spaces. Please re-enter."),
                              wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES | wxYES_DEFAULT | wxCENTRE);
            dlg.ShowModal();
            return false;
        }
        ...
        if (check_printable_area() == false) {
            MessageDialog dlg(this, _L("Please check bed printable shape and origin input."),
                              wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES | wxYES_DEFAULT | wxCENTRE);
            dlg.ShowModal();
            return false;
        }
        ...
        if (printer_name.empty()) {
            MessageDialog dlg(this, _L("You have not yet selected the printer to replace the nozzle, please choose."),
                              wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES | wxYES_DEFAULT | wxCENTRE);
            dlg.ShowModal();
            return false;
        }
    ...
    if (nozzle_dia == 0) {
        MessageDialog dlg(this, _L("The entered nozzle diameter is invalid, please re-enter:\n"),
                          wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxOK | wxYES_DEFAULT | wxCENTRE);
        int           res = dlg.ShowModal();
        return false;
    }
...
void CreatePrinterPresetDialog::on_preset_model_value_change(wxCommandEvent& e)
{
    ...
    if (m_printer_preset_vendor_selected.models.empty()) {
        BOOST_LOG_TRIVIAL(info) << __FUNCTION__
                                << " selected vendor has no models, and the vendor is: " << m_printer_preset_vendor_selected.id;
        return;
    }
...
wxString CreatePrinterPresetDialog::curr_create_printer_type() const
{
    ...
    for (const std::pair<RadioBox*, wxString>& printer_radio : m_create_type_btns) {
        if (printer_radio.first->GetValue()) {
            curr_selected_printer_type = printer_radio.second;
        }
    }
...
CreatePresetSuccessfulDialog::CreatePresetSuccessfulDialog(wxWindow* parent, const SuccessType& create_success_type)
    : DPIDialog(parent ? parent : nullptr,
                wxID_ANY,
                PRINTER == create_success_type ? _L("Printer Created Successfully") : _L("Filament Created Successfully"),
                wxDefaultPosition,
                wxDefaultSize,
...
void CreatePresetSuccessfulDialog::on_dpi_changed(const wxRect& suggested_rect) { Layout(); }

// [INTENT] Modal dialog for exporting various preset configurations (bundles, zip files).
// [STATE] Manages list of available printer and filament presets for export selection.
// [UNITY] Map to VisualElement-based ModalWindow. Use a Service for zipping/file operations.
...
ExportConfigsDialog::~ExportConfigsDialog()
{
    ...
    if (boost::filesystem::exists(temp_folder))
        boost::filesystem::remove_all(temp_folder);
}

void ExportConfigsDialog::on_dpi_changed(const wxRect& suggested_rect) { Layout(); }
...
std::string ExportConfigsDialog::initial_file_name(const wxString& path, const std::string file_name)
{
    ...
    if (boost::filesystem::exists(printer_export_path)) {
        MessageDialog dlg(this,
                          wxString::Format(_L("The '%s' folder already exists in the current directory. Do you want to clear it and "
...
wxBoxSizer* ExportConfigsDialog::create_export_config_item(wxWindow* parent)
{
    ...
    wxStaticText* static_export_printer_preset_bundle_text =
        new wxStaticText(parent, wxID_ANY,
                         _L("Printer and all the filament and process presets that belongs to the printer.\n"
    ...
    radioBoxSizer->Add(create_radio_item(m_exprot_type.filament_bundle, parent, wxEmptyString, m_export_type_btns), 0, wxEXPAND | wxTOP,
                       FromDIP(10));
    wxStaticText* static_export_filament_preset_bundle_text =
        new wxStaticText(parent, wxID_ANY, _L("User's filament preset set.\nCan be shared with others."), wxDefaultPosition, wxDefaultSize);
    ...
    radioBoxSizer->Add(create_radio_item(m_exprot_type.printer_preset, parent, wxEmptyString, m_export_type_btns), 0, wxEXPAND | wxTOP,
                       FromDIP(10));
    radioBoxSizer->Add(create_radio_item(m_exprot_type.filament_preset, parent, wxEmptyString, m_export_type_btns), 0, wxEXPAND | wxTOP,
                       FromDIP(10));
    radioBoxSizer->Add(create_radio_item(m_exprot_type.process_preset, parent, wxEmptyString, m_export_type_btns), 0, wxEXPAND | wxTOP,
                       FromDIP(10));
    horizontal_sizer->Add(radioBoxSizer, 0, wxEXPAND | wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(10));
...
wxBoxSizer* ExportConfigsDialog::create_radio_item(wxString                                     title,
                                                   wxWindow*                                    parent,
                                                   wxString                                     tooltip,
                                                   std::vector<std::pair<RadioBox*, wxString>>& radiobox_list)
{
...
// [INTENT] Zips multiple preset configuration files into a single archive.
// [PORTING_HAZARD:P2] Uses miniz (mz_zip_archive) for file compression.
// [UNITY] Replace with System.IO.Compression.ZipArchive or a dedicated export service in Unity.
ExportConfigsDialog::ExportCase ExportConfigsDialog::save_presets_to_zip(
    const std::string& export_file, const std::vector<std::pair<std::string, std::string>>& config_paths)
{
    ...
    for (std::pair<std::string, std::string> config_path : config_paths) {
        ...
        status = mz_zip_writer_add_file(&zip_archive, (preset_name).c_str(), encode_path(config_path.second.c_str()).c_str(), NULL, 0,
                                        MZ_DEFAULT_COMPRESSION);
        // status = mz_zip_writer_add_mem(&zip_archive, ("printer/" + printer_preset->name + ".json").c_str(), json_contents,
        // strlen(json_contents), MZ_DEFAULT_COMPRESSION);
        if (MZ_FALSE == status) {
        ...
        if (i == btn_idx) {
            ...
            if (export_type == m_exprot_type.preset_bundle) {
                for (std::pair<std::string, Preset*> preset : m_printer_presets) {
                    ...
                    if (m_filament_presets.find(preset_name) == m_filament_presets.end() &&
                        m_process_presets.find(preset_name) == m_process_presets.end() && preset.second->is_system)
                        continue;
                ...
                for (std::pair<std::string, std::vector<std::pair<std::string, Preset*>>> filament_name_to_preset :
                     m_filament_name_to_presets) {
                    if (filament_name_to_preset.second.empty())
                        continue;
                    wxString filament_name = wxString::FromUTF8(filament_name_to_preset.first);
                    m_preset_sizer->Add(create_checkbox(m_presets_window, filament_name, m_printer_name), 0,
                                        wxEXPAND | wxTOP | wxLEFT | wxRIGHT, FromDIP(5));
                }
                ...
                m_serial_text->SetLabel(_L("Only printer names with user printer presets will be displayed, and each preset you choose "
                                           "will be exported as a zip."));
...
ExportConfigsDialog::ExportCase ExportConfigsDialog::archive_preset_bundle_to_file(const wxString& path)
{
    ...
    for (std::pair<::CheckBox*, Preset*> checkbox_preset : m_preset) {
        if (checkbox_preset.first->GetValue()) {
            ...
            if (preset_path.empty()) {
                BOOST_LOG_TRIVIAL(info) << "Export printer preset: " << printer_preset->name
                                        << " skip because of the preset file path is empty.";
                continue;
            }

            // Add a file to the ZIP file
            std::string printer_config_file_name = "printer/" + printer_file_path.filename().string();
            status = mz_zip_writer_add_file(&zip_archive, printer_config_file_name.c_str(), encode_path(preset_path.c_str()).c_str(), NULL,
            ...
            if (m_filament_presets.end() != iter) {
                for (Preset* preset : iter->second) {
                    ...
                    if (filament_preset_path.empty()) {
                        BOOST_LOG_TRIVIAL(info)
                            << "Export filament preset: " << preset->name << " skip because of the preset file path is empty.";
                        continue;
                    }

                    std::string filament_config_file_name = "filament/" + filament_file_path.filename().string();
                    status = mz_zip_writer_add_file(&zip_archive, filament_config_file_name.c_str(),
                                                    encode_path(filament_preset_path.c_str()).c_str(), NULL, 0, MZ_DEFAULT_COMPRESSION);
                    if (MZ_FALSE == status) {
            ...
            if (m_process_presets.end() != iter) {
                for (Preset* preset : iter->second) {
                    ...
                    if (process_preset_path.empty()) {
                        BOOST_LOG_TRIVIAL(info)
                            << "Export process preset: " << preset->name << " skip because of the preset file path is empty.";
                        continue;
                    }

                    std::string process_config_file_name = "process/" + process_file_path.filename().string();
                    status = mz_zip_writer_add_file(&zip_archive, process_config_file_name.c_str(),
                                                    encode_path(process_preset_path.c_str()).c_str(), NULL, 0, MZ_DEFAULT_COMPRESSION);
                    if (MZ_FALSE == status) {
                        BOOST_LOG_TRIVIAL(info) << preset->name << " Failed to add file to ZIP archive";
                        mz_zip_writer_end(&zip_archive);
                        return ExportCase::ADD_FILE_FAIL;
...
ExportConfigsDialog::ExportCase ExportConfigsDialog::archive_filament_bundle_to_file(const wxString& path)
{
    ...
    for (std::pair<::CheckBox*, std::string> checkbox_filament_name : m_printer_name) {
        if (checkbox_filament_name.first->GetValue()) {
            ...
            std::unordered_map<std::string, std::vector<std::pair<std::string, Preset*>>>::iterator iter = m_filament_name_to_presets.find(
                filament_name);
            ...
            for (std::pair<std::string, Preset*> printer_name_to_preset : iter->second) {
                ...
                if (vendor_to_filament_name.find(std::make_pair(printer_vendor, filament_preset->name)) != vendor_to_filament_name.end())
                    continue;
                ...
                if (preset_path.empty()) {
                    BOOST_LOG_TRIVIAL(info) << "Export printer preset: " << filament_preset->name
                                            << " skip because of the preset file path is empty.";
                    continue;
                }
                // Add a file to the ZIP file
                std::string file_name = printer_vendor + "/" + filament_preset->name + ".json";
                status = mz_zip_writer_add_file(&zip_archive, file_name.c_str(), encode_path(preset_path.c_str()).c_str(), NULL, 0,
                                                MZ_DEFAULT_COMPRESSION);
                // status = mz_zip_writer_add_mem(&zip_archive, ("printer/" + printer_preset->name + ".json").c_str(), json_contents,
                // strlen(json_contents), MZ_DEFAULT_COMPRESSION);
                if (MZ_FALSE == status) {
    ...
    for (std::pair<::CheckBox*, std::string> checkbox_preset : m_printer_name) {
        if (checkbox_preset.first->GetValue()) {
            ...
            for (std::pair<std::string, Preset*> printer_name_preset : iter->second) {
                ...
                if (filament_presets.find(filament_preset->name) != filament_presets.end())
                    continue;
                filament_presets.insert(filament_preset->name);
                std::string preset_path = boost::filesystem::path(filament_preset->file).make_preferred().string();
                if (preset_path.empty()) {
                    BOOST_LOG_TRIVIAL(info) << "Export filament preset: " << filament_preset->name
                                            << " skip because of the filament file path is empty.";
                    continue;
                }
        ...
        if (checkbox_preset.first->GetValue()) {
            ...
            if (m_process_presets.end() != iter) {
                for (Preset* process_preset : iter->second) {
                    if (process_presets.find(process_preset->name) != process_presets.end())
                        continue;
...
wxWindow* ExportConfigsDialog::create_dialog_buttons(wxWindow* parent)
{
    ...
    dlg_btns->GetOK()->Bind(wxEVT_BUTTON, [this](wxCommandEvent& e) {
        if (!has_check_box_selected()) {
            MessageDialog dlg(this, _L("Please select at least one printer or filament."),
                              wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES | wxYES_DEFAULT | wxCENTRE);
            dlg.ShowModal();
            return;
        }
...
void ExportConfigsDialog::data_init()
{
    ...
    const std::deque<Preset>& filament_presets = preset_bundle.filaments.get_presets();
    for (const Preset& filament_preset : filament_presets) {
        if (filament_preset.is_system || filament_preset.is_default)
            continue;
        Preset*       new_filament_preset  = new Preset(filament_preset);
    ...
    , m_filament_serial("")
{
    ...
    if (get_filament_presets && !m_printer_compatible_presets.empty()) {
        ...
        if (!preset.get())
            preset = m_printer_compatible_presets.begin()->second[0];
        ...
        if (vendor_names && !vendor_names->values.empty())
            m_vendor_name = vendor_names->values[0];
        auto filament_types = dynamic_cast<ConfigOptionStrings*>(preset->config.option("filament_type"));
        if (filament_types && !filament_types->values.empty())
            m_filament_type = filament_types->values[0];
    ...
    m_note_text = new wxStaticText(
        this, wxID_ANY,
        _L("Note: If the only preset under this filament is deleted, the filament will be deleted after exiting the dialog."));
...
void EditFilamentPresetDialog::on_dpi_changed(const wxRect& suggested_rect) { Layout(); }
...
{
    if (m_selected_printer.empty())
        return;
    if (m_need_delete_preset_index < 0)
        return;
    std::unordered_map<std::string, std::vector<std::shared_ptr<Preset>>>::iterator iter = m_printer_compatible_presets.find(
        m_selected_printer);
    ...
    if (m_need_delete_preset_index >= filament_presets.size()) {
        BOOST_LOG_TRIVIAL(info) << __FUNCTION__ << " index error and selected printer is: " << m_selected_printer
                                << " and index: " << m_need_delete_preset_index;
        return;
    }
    ...
    if (need_delete_preset->name == wxGetApp().preset_bundle->filaments.get_selected_preset_name()) {
        ...
        if (is_base_preset) {
            msg = _L("Are you sure to delete the selected preset?\n"
                     "If the preset corresponds to a filament currently in use on your printer, please reset the filament information for "
                     "that slot.");
        } else {
            msg = _L("Are you sure to delete the selected preset?");
        }
        ...
        BOOST_LOG_TRIVIAL(info) << __LINE__ << " filament preset name: " << need_delete_preset->name
    ...
    if (filament_presets.empty())
        m_printer_compatible_presets.erase(iter);
...
void EditFilamentPresetDialog::edit_preset()
{
    ...
    if (m_need_edit_preset_index >= filament_presets.size()) {
        BOOST_LOG_TRIVIAL(info) << __FUNCTION__ << " index error and selected printer is: " << m_selected_printer
                                << " and index: " << m_need_edit_preset_index;
        return;
    }
...
wxWindow* EditFilamentPresetDialog::create_dialog_buttons()
{
    ...
    dlg_btns->GetFIRST()->Bind(
        wxEVT_BUTTON, ([this](wxCommandEvent& e) {
            ...
            if (wxID_YES == res) {
                ...
                for (std::shared_ptr<Preset> preset : inherit_preset_names) {
                    ...
                    BOOST_LOG_TRIVIAL(info) << __FUNCTION__ << " inherit filament name: " << preset->name
                                            << (delete_result ? " delete successful" : " delete failed");
                }
                for (std::shared_ptr<Preset> preset : root_preset_names) {
                    bool delete_result = delete_filament_preset_by_name(preset->name, next_selected_preset_name);
                    BOOST_LOG_TRIVIAL(info) << __FUNCTION__ << " root filament name: " << preset->name
                                            << (delete_result ? " delete successful" : " delete failed");
                }
                m_printer_compatible_presets.clear();
                wxGetApp().preset_bundle->filaments.select_preset_by_name(next_selected_preset_name, true);
...
CreatePresetForPrinterDialog::CreatePresetForPrinterDialog(
    wxWindow* parent, std::string filament_type, std::string filament_id, std::string filament_vendor, std::string filament_name)
...
void CreatePresetForPrinterDialog::on_dpi_changed(const wxRect& suggested_rect) { Layout(); }
...
void CreatePresetForPrinterDialog::get_visible_printer_and_compatible_filament_presets()
{
    ...
    for (const Preset& printer_preset : printer_presets) {
        if (printer_preset.is_visible) {
            if (m_preset_bundle->printers.get_preset_base(printer_preset) != &printer_preset)
                continue;
            if (m_preset_bundle->printers.select_preset_by_name(printer_preset.name, true)) {
                ...
                for (const Preset& filament_preset : filament_presets) {
                    ...
                    if (filament_preset_base == &filament_preset) {
                        filament_types = dynamic_cast<ConfigOptionStrings*>(
                            const_cast<Preset*>(&filament_preset)->config.option("filament_type"));
                    } else {
                        filament_types = dynamic_cast<ConfigOptionStrings*>(
                            const_cast<Preset*>(filament_preset_base)->config.option("filament_type"));
                    }
...
wxBoxSizer* CreatePresetForPrinterDialog::create_selected_printer_preset_sizer()
{
    ...
    m_selected_printer = new ComboBox(this, wxID_ANY, wxEmptyString, wxDefaultPosition, PRINTER_PRESET_MODEL_SIZE, 0, nullptr,
                                      wxCB_READONLY);
...
wxBoxSizer* CreatePresetForPrinterDialog::create_selected_filament_preset_sizer()
{
    ...
    m_selected_filament = new ComboBox(this, wxID_ANY, wxEmptyString, wxDefaultPosition, PRINTER_PRESET_MODEL_SIZE, 0, nullptr,
                                       wxCB_READONLY);
    ...
    m_selected_printer->Bind(wxEVT_COMBOBOX, [this](wxCommandEvent& e) {
        ...
        std::unordered_map<string, std::vector<std::shared_ptr<Preset>>>::iterator filament_iter = m_printer_compatible_filament_presets
                                                                                                       .find(into_u8(printer_name));
...
wxWindow* CreatePresetForPrinterDialog::create_dialog_buttons()
{
    ...
    dlg_btns->GetOK()->Bind(wxEVT_BUTTON, [this](wxCommandEvent& e) {
        ...
        if (filament_choice_to_filament_preset.end() != iter) {
            ...
            bool res = preset_bundle->filaments.clone_presets_for_filament(filament_preset.get(), failures, m_filament_name, m_filament_id,
                                                                           dynamic_config, printer_name);
            if (!res) {
                std::string failure_names;
                for (std::string& failure : failures) {
                    failure_names += failure + "\n";
                ...
                MessageDialog dlg(this,
                                  ...
                                  wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES_NO | wxYES_DEFAULT | wxCENTRE);
                if (dlg.ShowModal() == wxID_YES) {
                    res = preset_bundle->filaments.clone_presets_for_filament(filament_preset.get(), failures, m_filament_name,
                                                                              m_filament_id, dynamic_config, printer_name, true);
                    BOOST_LOG_TRIVIAL(info) << "clone filament  have failures  rewritten  is successful? " << res;
                } else {
            ...
            MessageDialog dlg(this, _L("The filament choice not find filament preset, please reselect it"),
                              wxString(SLIC3R_APP_FULL_NAME) + " - " + _L("Info"), wxYES | wxYES_DEFAULT | wxCENTRE);
            dlg.ShowModal();
            return;
        }
...
PresetTree::PresetTree(EditFilamentPresetDialog* dialog) : m_parent_dialog(dialog) {}
...
wxPanel* PresetTree::get_child_item(wxPanel* parent, std::shared_ptr<Preset> preset, std::string printer_name, int preset_index, bool is_last)
{
    ...
    if (preset->inherits() == "" && preset->base_id != "")
        base_id_error = true;
    if (base_id_error) {
