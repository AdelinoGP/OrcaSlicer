...
// [INTENT] Defines the interface for OBJ color mapping UI, including clustering logic and thumbnail preview orchestration.
class ObjColorPanel : public wxPanel
{
public:
    // [STATE] Mapping parameters: in_out carries the mesh data and color buffers; extruder_colours represents available project filaments.
...
private:
    ...
    // [STATE] Original input colors from OBJ file and their clustered representation.
...
// [INTENT] Main dialog for OBJ color mapping, providing OK/Cancel actions and scaling support.
