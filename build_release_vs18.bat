@REM OrcaSlicer build script for Windows (Visual Studio 18 / 2025)
@echo off
set WP=%CD%
...
if "%1"=="pack" (
    ...
    echo packing deps: OrcaSlicer_dep_win64_!build_date!_vs18.zip

    %WP%/tools/7z.exe a OrcaSlicer_dep_win64_!build_date!_vs18.zip OrcaSlicer_dep
    exit /b 0
)
...
cmake ../ -G "Visual Studio 18 2026" -A %arch% -DCMAKE_BUILD_TYPE=%build_type%
