...
_Generated: 2026-03-25 06:55:39 UTC_

## Git Context

- **Branch:** `agent/gui-analysis`
- **HEAD:** f7ed0392c2: chore: auto-commit before merge (loop primary)
...
```
Continue the previous work. Remaining tasks (378):
- P0-T006: Main Window Class Identification
- T106 annotate: src/libvgcode/include/Viewer.hpp
- T132 annotate: src/libvgcode/src/ToolMarker.hpp
- T153 annotate: src/slic3r/GUI/PresetComboBoxes.cpp
...
- Deliverables: Annotations verified/added
- Substantive additions: Verified existing annotations for class, state, event flow, and Unity porting hazards
- Verification excerpt: // [STATE] The popup tracks the machine selection state and lifecycle so the UI never loses focus after a switch.
- Unity-impact summary:
  - Tabbook needs UI Toolkit TabView
  - wxTimer needs Unity Dispatcher/Coroutine
  - PopupWindow needs explicit controller
- Hazards found: 2 (P2, P3)
- Git: N/A (Annotations were pre-existing)
